  ...
  return (
    <div className="w-full bg-gray-50 p-8 max-[425px]:p-0">
      ...
      <div className="review-container mt-8">
        <div className="review flex flex-col md:flex-row justify-between items-start">
          {/* Ratings Section */}
        ...
        {/* Comments Section */}
        <div className="comments-section w-full mt-8 p-4 m-3">
          {reviews.map((review) => (
            <div
              key={review.id}
              className="comment max-w-[100%] bg-white p-4 rounded-lg shadow-md mb-4"
            >
