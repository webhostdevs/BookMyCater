...
const VendorSearch = () => {
    ...
    useEffect(() => {
        const fetchLocations = async () => {
            const response = await axios.get('`http://localhost/backend/vendor_locations.php'); // Adjust this endpoint to get locations
    ...
    const handleSearch = async () => {
        const response = await axios.get('`http://localhost/backend/vendor_search.php', {
            params: {
